...
Based on these initial results, we also trained a larger diffusion model (big in Tab. 7) 
in the latent space of the VQregularized first stage without attention, obtaining SOTA results.

The config that matches such condition is reported in configs/latent-diffusion/inpainting_classical.yaml
