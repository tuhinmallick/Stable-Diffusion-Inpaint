...
class InpaintingDynaFillTargetSegmentation(Dataset):
    def __init__(self,
                 csv_file,
                 data_root,
                 partition,
    ...
    def _transform_and_normalize_inference(self, image_path, image_target_path, mask_path, seg_mask_path, resize_to):
        ...
        batch = {"image": image_target, "mask": mask, "masked_image": masked_image, "hint": seg_mask}
...
class InpaintingDynaFillTargetSegmentationTrain(InpaintingDynaFillTargetSegmentation):
...
class InpaintingDynaFillTargetSegmentationValidation(InpaintingDynaFillTargetSegmentation):
    def __init__(self, csv_file,data_root, **kwargs):
...
if __name__=="__main__":
    ...
    ip_train = InpaintingDynaFillTargetSegmentationTrain(size = 256,csv_file=csv_file, data_root=data_root)
