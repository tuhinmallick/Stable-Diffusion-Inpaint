...
class InpaintingDynaFillMaskOnTargetSegmentation(Dataset):
    def __init__(self,
                 csv_file,
                 data_root,
                 partition,
        ...
        self.image_paths = self.csv_df["image_path_target"]
...
class InpaintingDynaFillMaskOnTargetSegmentationTrain(InpaintingDynaFillMaskOnTargetSegmentation):
...
class InpaintingDynaFillMaskOnTargetSegmentationValidation(InpaintingDynaFillMaskOnTargetSegmentation):
    def __init__(self, csv_file,data_root, **kwargs):
...
if __name__=="__main__":
    ...
    ip_train = InpaintingDynaFillMaskOnTargetSegmentationTrain(size = 512,csv_file=csv_file, data_root=data_root)
